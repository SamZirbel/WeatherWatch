...
# !!! Main.UserApp is configured as an alias for Main.WeatherWatch and you might encounter it in some tests
using Main.WeatherWatch, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "WeatherWatch tests" begin
  @includetests ARGS
end
